...
static int logicalSize=5;
    public static void main(String[] args) {
       ...
       fruit[4]="Strawberry";
        ...
        showFruit(fruit);
        System.out.println("Adding StarFruit and Papaya");
        loc=findInsertPoint(fruit,"StarFruit");
        if(insert(fruit,"StarFruit",loc)){
            System.out.println("Added StarFruit ok");
            
        }
        else{
            System.out.println("Could not add StarFruit");
        }
        insert(fruit,"Papaya",findInsertPoint(fruit,"Papaya"));
        showFruit(fruit);
        System.out.println("\n-------------\n");
        System.out.println("Deleting Elderberry");
        loc=search(fruit,"Elderberry");
        delete(fruit,loc);
        showFruit(fruit);
